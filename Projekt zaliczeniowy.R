...
#wyszczegolnienie polaków-mężczyzn
polacy <- RankingMM[RankingMM$Narodowosc=="POL",]

#srednia punktów w podziale na narodowości kobiet
...
#średnia i suma punktow kobiet wzgledem narodowosci
...
lider <- function(typ)
{
  switch(typ,
         Polska= {
           ...
           cat("Najlepsza zawodniczka z kraju",typ,"to ", najlepsza$`Imie i nazwisko`,", ktora ma", najlepsza$Wiek,"lat. Zajmuje ona ", najlepsza$`Miejsce w rankingu`,"miejsce w światowym rankingu WTA i ma na swoim koncie",najlepsza$Punkty,"punktow."  )
         },
         Australia= {
         ...
         Mezczyzna=
           {
             ...
             {
               cat("Wprowadzono nieprawidłowy przedział wiekowy")
             }
           },
         Kobieta=
           {
